...
def save_bottleneck():
    ...
    for train_val in ['train', 'validation']:
        ...
        with open('/home/azure/passion/AI/Category and Attribute Prediction Benchmark/dataset/bottleneck/btl_' + train_val + '.txt', 'w') as f_image:
            for class_name in class_names:
                ...
                for index, image in enumerate(images_path_name):
                    ...
                    btl_save_file_name = btl_path + train_val + '/btl_' + train_val + '_' + class_name + '_' + str(index).zfill(7) + '.npy'
...
def train_model():
    ...
    with open('/home/azure/passion/AI/Category and Attribute Prediction Benchmark/dataset/bottleneck//btl_train.txt') as f_btl_train:
    ...
    # Get list of image IoU values
    with open('/home/azure/passion/AI/Category and Attribute Prediction Benchmark/dataset/bottleneck/btl_validation.txt') as f_btl_val:
    ...
    filepath = "/home/azure/passion/AI/Category and Attribute Prediction Benchmark/dataset/output/best-weights-{epoch:03d}-{val_loss:.4f}.hdf5"
